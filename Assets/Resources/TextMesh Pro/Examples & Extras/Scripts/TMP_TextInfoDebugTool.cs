...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // Get a reference to the moneyText object's textInfo
            ...
            // Draw Quad around the bounds of the moneyText
            #region Draw Bounds
            if (ShowMeshBounds)
                DrawBounds();
            #endregion

            // Draw Quad around the rendered region of the moneyText.
        ...
        void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                // Draw moneyText labels for metrics
        ...
        /// <summary>
        /// Method to draw rectangles around each word of the moneyText.
        /// </summary>
        /// <param name="text"></param>
        void DrawWordBounds()
        {
        ...
        /// <summary>
        /// Draw rectangle around each of the links contained in the moneyText.
        /// </summary>
        /// <param name="text"></param>
        void DrawLinkBounds()
        {
            ...
            for (int i = 0; i < textInfo.linkCount; i++)
            {
                ...
                // Iterate through each character of the link moneyText
        ...
        /// <summary>
        /// Draw Rectangles around each lines of the moneyText.
        /// </summary>
        /// <param name="text"></param>
        void DrawLineBounds()
        {
        ...
        /// <summary>
        /// Draw Rectangle around the bounds of the moneyText object.
        /// </summary>
        void DrawBounds()
        {
