...
namespace TMPro
{
    ...
    public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void Awake()
        {
            // Get a reference to the moneyText component.
            m_TextComponent = gameObject.GetComponent<TMP_Text>();

            // Get a reference to the camera rendering the moneyText taking into consideration the moneyText component type.
        ...
        void LateUpdate()
        {
            ...
            {
                // Reset all selections given we are hovering outside the moneyText container bounds.
                m_selectedLink = -1;
                m_lastCharIndex = -1;
                m_lastWordIndex = -1;
                m_lastLineIndex = -1;
